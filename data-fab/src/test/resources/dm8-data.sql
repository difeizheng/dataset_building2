...
-- 测试标注记录
INSERT INTO t_label_record (id, task_id, sample_id, annotator_id, annotations, duration_seconds, create_time, update_time)
VALUES (1, 1, 1, 1, '{"label":"正面"}', 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO t_label_record (id, task_id, sample_id, annotator_id, annotations, duration_seconds, create_time, update_time)
VALUES (2, 1, 1, 2, '{"label":"正面"}', 25, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO t_label_record (id, task_id, sample_id, annotator_id, annotations, duration_seconds, create_time, update_time)
VALUES (3, 1, 2, 1, '{"label":"负面"}', 28, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO t_label_record (id, task_id, sample_id, annotator_id, annotations, duration_seconds, create_time, update_time)
VALUES (4, 1, 2, 2, '{"label":"中性"}', 32, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
